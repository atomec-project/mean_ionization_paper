...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Supplementary Information_files/Supplementary Information_10_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Supplementary Information_files/Supplementary Information_27_0.png}
    \end{center}
    { \hspace*{\fill} \\}
