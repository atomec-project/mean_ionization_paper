...
\begin{gather}
g_{nl}(\epsilon) =\frac{8}{ \pi \Delta_{nl}^2} \sqrt{(\epsilon^+_{nl}-\epsilon_{knl})(\epsilon_{knl} - \epsilon^-_{nl})}\,,\\
...
We now simply the above expressions. To the best of our knowledge, this
simplication was not discussed in the original paper. Firstly, we note
that the energy spacing in the discretization of the energy band
...
\begin{equation}
\delta\epsilon_{knl} \times g_{knl}(\epsilon_{knl},\epsilon_{nl}^\pm) = \frac{8}{(N_k-1)^2}\sqrt{k(N_k-1-k)}\,.
\end{equation}
...
w_k = \frac{8}{(N_k-1)^2}\sqrt{k(N_k-1-k)}\,.
\end{gather}
